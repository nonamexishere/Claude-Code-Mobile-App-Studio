...
5. **MCP shortcut**: If the PostHog MCP (`/setup-mcp posthog`) or Firebase MCP (`firebase experimental:mcp`) is connected, query events, run insights, and inspect feature flags directly. See `.claude/docs/mcp-servers.md`.
